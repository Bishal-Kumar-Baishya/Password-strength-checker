...
## About the tool
This tool gets a input from user to enter a password. Based on that input password, it checks whether it contains uppercase letters, lowercase letters, digits, and symbols. It then gives a score based on the password out of 5 by specifying the password with Weak, Medium and Strong.
